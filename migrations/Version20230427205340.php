 ...
 */
final class Version20230427205340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rate_review (id INT AUTO_INCREMENT NOT NULL, recipe_id INT NOT NULL, user_id INT NOT NULL, rate DOUBLE PRECISION NOT NULL, review LONGTEXT NOT NULL, INDEX IDX_DBB4B0AD59D8A214 (recipe_id), INDEX IDX_DBB4B0ADA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE recipe CHANGE cook_timee cook_time INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe CHANGE cook_time cook_timee INT NOT NULL');
    }
}
